(ns ygg.plugin-package-scaffold
...
(defn- package-readme
  [package-id]
  (str "# " package-id "\n\n"
       "Yggdrasil plugin package scaffold.\n\n"
       "Useful commands:\n\n"
       "```sh\n"
       "bb plugin validate .\n"
       "bb plugin diagnose .\n"
...
(defn- benchmark-readme
  ...
  (str "# Benchmarks for " package-id "\n\n"
       ...
       "`ygg.plugin.edn`; replace it with real `bb bench agent-report` output.\n\n"
       ...
       "  --baseline-report .dev/ygg/plugin-bench/core/agent-report.json \\\n"
       "  --candidate-report .dev/ygg/plugin-bench/plugin/agent-report.json\n"
       "```\n\n"
       ...
       "              :kind :agent-report\n"
       "              :case-id \"" package-id "-architecture\"\n"
...
(defn- agent-report-template
  [package-id]
  (str "{\n"
       "  \"schema\": \"ygg.benchmark.agent-report/v1\",\n"
       "  \"suite-id\": \"" package-id "-plugin\",\n"
       "  \"note\": \"Template only. Replace with real bb bench agent-report output before listing a benchmark artifact in ygg.plugin.edn.\",\n"
       "  \"cases\": 0,\n"
       "  \"completed\": 0,\n"
       "  \"runs\": 0,\n"
       "  \"results\": []\n"
