...
(defn usage
  ...
  (str/join
   ...
   ["Usage:"
    ...
    "  bench agent-baseline <benchmark.edn> [--case ID] [--cases ID,ID] [--retriever auto|hybrid|lexical|semantic|local-vector|codebase-memory|graphify] [--limit N] [--doc-limit N] [--retrieval-limit N] [--vector-model MODEL] [--vector-command CMD] [--codebase-memory-command CMD] [--codebase-memory-bin PATH] [--codebase-memory-cache-dir DIR] [--graphify-command CMD] [--graphify-bin CMD] [--graphify-output-dir DIR] [--graphify-query-budget N] [--graphify-max-workers N] [--graphify-include-non-code] [--parser-worker none|java|dotnet|javascript|typescript|all] [--index-timeout-ms N] [--skip-existing] [--out DIR] [--json]"
