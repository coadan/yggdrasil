(ns agraph.dependency.resolve
  ...
  (:require [agraph.dependency.resolve.common :as common]
            [agraph.dependency.resolve.dotnet :as dotnet]
            [agraph.dependency.resolve.go :as go]
            [agraph.dependency.resolve.java :as java]
            [agraph.dependency.resolve.javascript :as javascript]
            [agraph.dependency.resolve.python :as python]
            [agraph.dependency.resolve.rust :as rust]))
