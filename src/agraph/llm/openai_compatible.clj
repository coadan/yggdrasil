...
(defn api-key
  ...
  (case (keyword provider)
    :deepseek (env/get-env "AGRAPH_DEEPSEEK_API_KEY"
                           "DEEPSEEK_API_KEY")
    :openrouter (env/get-env "AGRAPH_OPENROUTER_API_KEY"
                             "OPENROUTER_API_KEY"
                             "OPEN_ROUTER_API_KEY")
    :openai (env/get-env "AGRAPH_OPENAI_API_KEY" "OPENAI_API_KEY")
    nil))
  ...
  (let [provider (keyword provider)
    ...
    (when-not api-key-value
      (throw (ex-info "Missing LLM API key."
                      {:provider provider
                       :env ["AGRAPH_DEEPSEEK_API_KEY"
                             "DEEPSEEK_API_KEY"
                             "AGRAPH_OPENROUTER_API_KEY"
                             "OPENROUTER_API_KEY"
                             "AGRAPH_OPENAI_API_KEY"
                             "OPENAI_API_KEY"]})))
