...
(defn- instruction-section
  ...
  (str begin-marker "\n"
       ...
       "with graph-basis freshness, answerability, candidate files, snippets, "
       "relationships, graph facts, and drilldowns. Treat returned snippets as "
       "already-read source context and use relationships for nearby mechanical "
       "edges before broad grep/read loops.\n\n"
