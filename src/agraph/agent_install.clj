...
(defn- instruction-section
  ...
  (str begin-marker "\n"
       ...
       "Start with:\n\n"
       "```sh\n"
       "agraph sync inspect <project.edn> --json\n"
       "agraph sync <project.edn> --check --map agraph.map.json\n"
       "agraph view systems --project <project-id> --detail primary\n"
       "```\n\n"
       "`sync inspect --json` returns the project evidence surface with "
       "`available`, `counts`, and structured `nextActions`; follow those rows "
       ...
       "`agraph_work_heartbeat`, `agraph_work_complete`, "
