...
(defn- instruction-section
  ...
  (str begin-marker "\n"
       ...
       "`agraph_view_systems`, `agraph_sync_check`, `agraph_work_list`, "
       "`agraph_work_show`, `agraph_work_pull`, `agraph_work_heartbeat`, "
       "`agraph_work_complete`, `agraph_work_release`, and `agraph_work_reject`.\n\n"
