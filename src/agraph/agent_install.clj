...
(defn- instruction-section
  ...
  (str begin-marker "\n"
       ...
       "source, use the plugin lane before concluding AGraph has no evidence:\n\n"
       "```sh\n"
  ...
  {:matcher "Bash"
   :hooks [{:type "command"
            :command (str
                      ...
                      "Prefer `agraph sync inspect <project.edn> --map agraph.map.json --json` "
                      "to inspect freshness and evidence.families, then "
                      "`agraph explore \\\"<question>\\\" --project "
