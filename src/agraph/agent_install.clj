...
(defn- instruction-section
  ...
  (str begin-marker "\n"
       ...
       "coverage counts, extractor fingerprint groups, diagnostics, and "
       "structured `nextActions`; follow freshness and coverage actions before "
       "trusting absence of graph evidence.\n\n"
       ...
       "nearby mechanical edges before broad grep/read loops. If `status` or "
       "`answerability` is `limited`, `empty`, `stale`, or `unsynced`, follow "
