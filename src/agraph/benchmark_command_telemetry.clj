...
(defn- aggregate-optional-segment-telemetry
  ...
  (if (some :segmentCount telemetry)
    (assoc summary
           :segmentCount (reduce + 0 (map #(long (or (:segmentCount %) 0)) telemetry))
           :agraphSegmentCount (reduce + 0 (map #(long (or (:agraphSegmentCount %) 0)) telemetry))
           :searchSegmentCount (reduce + 0 (map #(long (or (:searchSegmentCount %) 0)) telemetry))
           :fileReadSegmentCount (reduce + 0 (map #(long (or (:fileReadSegmentCount %) 0)) telemetry))
           :shellSegmentCount (reduce + 0 (map #(long (or (:shellSegmentCount %) 0)) telemetry)))
    summary))
