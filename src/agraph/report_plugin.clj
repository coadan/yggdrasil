...
(def input-schema
  "agraph.report-plugin.input/v1")

(def result-schema
  "agraph.report-plugin.result/v1")

(def bundle-schema
  "agraph.report.plugins/v1")

(def contract-version
  "agraph.report-plugin/v1")
...
(defn core-panels
  "Return first-party AGraph report panels using the same contract as plugins."
  [report]
