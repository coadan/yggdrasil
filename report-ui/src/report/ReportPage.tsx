...
import type { AGraphGraph, AGraphReport, CountRow, ReportPluginDiagnostic, ReportPluginPanel } from "../data/types";
...
function panelPluginId(panel: ReportPluginPanel): string {
  return String(panel.plugin?.id || "unknown-plugin");
}

function pluginPanels(report: AGraphReport): ReportPluginPanel[] {
...
function externalPanels(report: AGraphReport): ReportPluginPanel[] {
...
function PluginPanel({ panel }: { panel: ReportPluginPanel }) {
  return (
...
function PluginPanelList({ report, slot, includeCore = false }: { report: AGraphReport; slot?: string; includeCore?: boolean }) {
...
function PluginDiagnostics({ diagnostics }: { diagnostics: ReportPluginDiagnostic[] }) {
