...
import type { YggEdge, YggGraph } from "./types";

export type GraphLayout = "circle" | "grid";

export function edgeKey(edge: YggEdge): string {
...
export function toGraphology(data: YggGraph, layout: GraphLayout = "circle"): Graph {
