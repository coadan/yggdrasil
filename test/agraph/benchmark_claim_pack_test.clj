(ns agraph.benchmark-claim-pack-test
...
(deftest writes-benchmark-claim-pack
  (let [root (temp-dir "agraph-claim-pack")
        shell-path (spit-json! root
                               ...
                               (report {:mode "shell-only"
                                        ...
                                        :tokens {:inputTokens 1000
                                                 ...
                                                 :totalTokens 1500
                                                 :costUsd 0.1}}))
        agraph-path (spit-json! root
                                "agraph/agent-report.json"
                                (-> (report {:mode "agraph"
                                             :recall 0.75
