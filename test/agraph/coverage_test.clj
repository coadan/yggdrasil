...
(deftest project-coverage-reports-supported-and-skipped-source-types
  (let [root (temp-dir "agraph-coverage-repo")]
    ...
    (let [report (coverage/project-coverage
      ...
      (is (= 1 (:count (row-by :kind "helm" (:files-by-kind report)))))
      (is (= 5 (:count (row-by :kind "ops-config" (:files-by-kind report)))))
      (is (= 1 (:count (row-by :kind "yaml" (:files-by-kind report)))))
      ...
      (is (= 1 (:count (row-by :kind "php" (:files-by-kind report)))))
      (is (= 1 (:count (row-by :kind "prisma" (:files-by-kind report)))))
      (is (= 1 (:count (row-by :kind "dbt" (:files-by-kind report)))))
      ...
      (is (= 30 (:count (row-by :kind "manifest" (:files-by-kind report)))))
